...
@Component({
  ...
  host: {
    'class': 'py-2 px-3 outline outline-2 outline-brand outline-offset-0 border-0 rounded-none bg-transparent min-w-36 w-fit disabled:grayscale disabled:opacity-50',
